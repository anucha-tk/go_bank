...
func TestTransferAPI(t *testing.T) {
	...
	user1, _ := createfakerUser(t)
	user2, _ := createfakerUser(t)
	user3, _ := createfakerUser(t)

	account1 := createFakerAccount(user1.Username)
	account2 := createFakerAccount(user2.Username)
	account3 := createFakerAccount(user3.Username)
